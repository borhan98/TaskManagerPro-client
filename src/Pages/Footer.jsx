...
import { FaApple, FaFacebook, FaGooglePlay, FaInstagram, FaYoutube } from "react-icons/fa";
        ...
        <footer className="container mx-auto px-2 lg:px-0 grid gap-6 md:grid-cols-3 footer p-10 text-neutral-content">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a className="hover:ml-1 duration-300" href="#">- About Us</a></li>
              <li><a className="hover:ml-1 duration-300" href="#">- Features</a></li>
          ...
          <div className="w-full">
            ...
            <button className="flex items-center text-xl rounded-md gap-2 border py-3 px-5 w-full">
              <span className="text-4xl mr-2"><FaApple /></span>
            ...
            <button className="flex items-center text-xl rounded-md gap-2 border py-3 px-5 w-full">
              <span className="text-4xl mr-2"><FaGooglePlay /></span>
              <p className="flex flex-col items-start">
