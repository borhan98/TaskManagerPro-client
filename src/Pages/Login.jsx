...
const Login = () => {
  ...
  return (
    <div className="py-10 min-h-screen w-full bg-gradient-to-b from-[#E96A04] via-[#592801] to-[#000] ">
      <div className="max-w-md shadow-2xl mx-auto px-4 py-10 rounded-md bg-[#0000004f] ">
        <div className="flex items-center gap-4 mb-10">
          ...
          <h3 className="text-2xl w-6/12 text-center capitalize font-medium text-zinc-200">
            Welcome back!
          </h3>
          <div className="h-[2px] w-3/12 bg-base-200"></div>
        </div>
        <form className="space-y-6">
          ...
          {/* Sign In */}
          <button className="py-2 md:py-3 px-2 md:px-4 rounded-md capitalize border w-full text-zinc-200 font-medium hover:tracking-wider duration-300">
            Sign in
          </button>
          {/* Social login */}
          <div className="flex items-center gap-4 mb-10">
        ...
        <p className="mt-16 text-center text-zinc-200">Don&#39;t have account? <Link to={"/register"} className="text-[#E96A04]">SingUp Now</Link></p>
      </div>
    </div>
  );
};
